...
dropdownlist = [{'label':i, 'value':i} for i in spacex_df['Launch Site'].unique()]
dropdownlist.insert(0, {'label':'All Sites', 'value': 'ALL'})
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=dropdownlist,
                                value = 'ALL',
...
def pie_graph(site):
    if site == "ALL":
        ...
        df_site['count'] = 1
        fig = px.pie(df_site, values = 'count', names = 'class', title= f"Total Success Launches for site {site}")
...
def scatter_graph(site, payload):
